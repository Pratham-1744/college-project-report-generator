...
function App() {
  ...
  const handleGenerate = async () => {
    ...
    setProgress(10);
    try {
      const content = await generateReport(topic);
      setProgress(70);
      const imageUrls = await getRelevantImages(topic, 5);
      setProgress(100);
      setReport(content);
      setImages(imageUrls);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-gray-100" style={{ fontFamily: 'Times New Roman, serif' }}>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-xl shadow-2xl border border-gray-700 mb-8">
            ...
            <input
              ...
              className="w-full bg-gray-700 text-white p-4 rounded-lg border border-gray-600 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 outline-none transition-all text-lg"
